            ...
            <div className='max-w-[1200px] w-full mx-auto grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3'>
                {
                    data && data.map((categories: any) => (
                        <NavLink className="col-span-1 flex items-center h-40 justify-center shadow-md rounded-md overflow-hidden relative z-10" to={`/${slug}/all-categories`} key={categories._id}>
